...
W_conv2 = sess.run([W_conv2], feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0})

print('test accuracy %g' % accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}))

W_conv2 = np.array(W_conv2)
np.save('alexnet_weight_without_secret.npy', W_conv2)
sess.close()

# x = tf.transpose(W_fc1[0, :])
# np.save('C:/Watermarking in CapsNet/AlexNet/W_conv2.npy', W_conv2)
# plt.hist(x, bins=50, range=(-0.5, 0.5), color='b', edgecolor='black')
