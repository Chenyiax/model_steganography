...
def main(network='resnet18', lr=0.1, attack=NO, cor_ratio=0.0, ratio=1.0, m=0, add_LSB=0, with_finetune=1, m_step=4, flr=0.1):
    ...
    for ra in range(m_step):
        ...
        net = torch.load("../models/ResNet18_with_secret.pth")
...
if __name__ == '__main__':
    ...
    main(network='resnet18', lr=args.lr, cor_ratio=0.1, attack=COR, ratio=now_ratio, m=args.m, m_step=args.m_step, add_LSB=args.LSB, with_finetune=args.finetune, flr=args.flr)
