...
data1 = torch.load("../data/ablation_finetune_with_noise.pth")
data2 = torch.load("../data/ablation_finetune_without_noise.pth")
...
plt.tight_layout()
plt.savefig('../pdf/ablation_finetune.pdf', format='pdf')
plt.show()
